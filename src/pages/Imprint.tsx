  ...
  return (
    <div className="pt-24 pb-16 bg-dark-400 min-h-screen">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl md:text-4xl font-mono font-bold mb-8 text-primary-500">Impressum</h1>
        
        <div className="max-w-3xl bg-dark-500 p-8 border border-dark-100">
          <h2 className="text-xl font-mono text-primary-500 mb-4">Angaben gemäß § 5 TMG</h2>
          <div className="mb-8">
          ...
          <h2 className="text-xl font-mono text-primary-500 mb-4">Kontakt</h2>
          <div className="mb-8">
          ...
          <h2 className="text-xl font-mono text-primary-500 mb-4">Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</h2>
          <div className="mb-8">
          ...
          <h2 className="text-xl font-mono text-primary-500 mb-4">Umsatzsteuer-Identifikationsnummer</h2>
          <div className="mb-8">
          ...
          <h2 className="text-xl font-mono text-primary-500 mb-4">Online-Streitbeilegung gemäß Art. 14 Abs. 1 ODR-VO</h2>
          <div className="mb-8">
          ...
          <h2 className="text-xl font-mono text-primary-500 mb-4">Hinweis nach § 36 VSBG</h2>
          <div>
